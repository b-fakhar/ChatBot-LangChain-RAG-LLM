...
class Trainer:
    ...
    def train_fn(self, epoch):
        ...
        for batch in self.train_loader:
            ...
            if self.problem_type == "multi_label_classification":
                ...
                pred_label = 1#torch.argmax(outputs.logits, axis=-1)
                # loss_bs = cross_entropy(outputs.logits, 
    ...
    # def _check_validation_metric(self):
    #     self.model.eval()
    #     all_logits = []
    #     all_labels = []
    ...
    #     val_metrics = compute_metrics(logits       = all_logits,
    #                                   labels       = all_labels,
